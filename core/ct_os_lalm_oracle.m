function [x,rmsd,pres,dres] = ct_os_lalm_oracle(...
    y,A,W,R,x0,...
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using modified OS-LALM-oracle (nBlock = %g, alpha = %g, rho = %g, option = %s)...\\n',nBlock,alpha,rho,option);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
