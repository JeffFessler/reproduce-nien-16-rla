  function [x, info] = ct_os_fgm(x0, Ab, yi, R, varargin)
%|function [x, info] = ct_os_fgm(x0, Ab, yi, R, [options])
%|
...
%|    momentum                type of momentum (default: 'std')
%|
%| out
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-FGM (nblock = %g, momentum = %s)...\\n',nblock,arg.momentum);
fprintf(str.info);
str.log = str.info;
