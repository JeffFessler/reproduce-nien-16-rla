function x = ct_os_partial_nu_sqs(...
    y,A,W,R,x0,...
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-partialNU-SQS (nBlock = %g, iUpdate = [%s], t = %g, epsilon = %g)...\\n',nBlock,num2str(iUpdate),t,epsilon);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
