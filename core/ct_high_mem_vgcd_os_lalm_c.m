function x = ct_high_mem_vgcd_os_lalm_c(...
    y,A,W,R,x0,...
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using high-memory vGCD OS-LALM with continuation (nBlock = %g, eta = %g)...\\n',nBlock,eta);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
