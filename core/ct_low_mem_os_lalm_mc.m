function x = ct_low_mem_os_lalm_mc(...
    y,A,W,R,x0,...
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using [max curv.] low-memory OS-LALM with H-weighting (nBlock = %g, eta = %g)...\\n',nBlock,eta);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
