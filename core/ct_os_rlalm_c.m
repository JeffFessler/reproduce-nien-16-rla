...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-rLALM with continuation (nBlock = %g, nDenoise = %g, theta = %g)...\\n',nBlock,nDenoise,theta);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
