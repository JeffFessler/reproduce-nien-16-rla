  function [xs, info] = pwls_os_nes83(x, Ab, yi, R, varargin)
%|function [xs, info] = pwls_os_nes83(x, Ab, yi, R, [options])
%|
%| penalized weighted least squares estimation / image reconstruction
%| using nesterov's first fast gradient method with
