...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-gLALM with varying theta (nBlock = %g, nDenoise = %g, rho = %g)...\\n',nBlock,nDenoise,rho);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
