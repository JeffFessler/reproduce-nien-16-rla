...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-Nes05-NU (nBlock = %g, iUpdate = [%s], t = %g, epsilon = %g)...\\n',nBlock,num2str(iUpdate),t,epsilon);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
    ...
    for iblock = iOrder
        ...
        sgrad = sgrad+s*grad;
        dsqs = dwls+compute_reg_sqs(R,wt,z,ut)+eps;
