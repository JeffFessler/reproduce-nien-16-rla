...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using SAG-LALM using max curvature (nBlock = %g, nDenoise = %g, rho = %g)...\\n',nBlock,nDenoise,rho);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
