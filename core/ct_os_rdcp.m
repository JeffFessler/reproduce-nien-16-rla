  function [x, info] = ct_os_rdcp(x0, Ab, yi, R, varargin)
%|function [x, info] = ct_os_rdcp(x0, Ab, yi, R, [options])
%|
%| model-based 3d x-ray ct image reconstruction using relaxed dual chambolle-
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-rDCP (nblock = %g)...\\n',nblock);
fprintf(str.info);
str.log = str.info;
