function [x,objv,rmsd] = ir_admm_u_Ax_v_Cx_cont2(x0,y,A,R,eta,nPCG,niter,xref)
...
fprintf('Start solving image restoration problem using ADMM with u = Ax and v = Cx splits (rho = cont., eta = %g, nPCG = %g)...\n',eta,nPCG);
for iter = 1:niter
