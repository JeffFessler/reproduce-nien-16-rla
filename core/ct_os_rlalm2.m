function x = ct_os_rlalm2(...
    y,A,W,R,x0,...
    nIter,nBlock,nDenoise,rho,gamma,...
    xref,iROI,...
    iSave,sDir...
    )
...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-rLALM (nBlock = %g, nDenoise = %g, rho = %g, gamma = %g)...\\n',nBlock,nDenoise,rho,gamma);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
