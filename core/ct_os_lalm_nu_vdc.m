...
str.info = sprintf('Start solving X-ray CT image reconstruction problem using OS-LALM-NU with voxel-dependent continuation (nBlock = %g, nDenoise = %g, iUpdate = [%s], t = %g, epsilon = %g)...\\n',nBlock,nDenoise,num2str(iUpdate),t,epsilon);
fprintf(str.info);
str.log = str.info;
for iter = 1:nIter
    tic;
