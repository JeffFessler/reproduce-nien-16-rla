  function x = edge_shrink(y, R, den, varargin)
%|function x = edge_shrink(y, R, den, [option])
%|
...
% coef = implicit_shrink_mat(y,winv,kappa,offsets,beta,phi,delta,N);
% coef = implicit_shrink_mex(y,winv,kappa,offsets,beta,pot,delta,N);
coef = parallel_implicit_shrink_mex(y,winv,kappa,offsets,beta,pot,delta,N,nthread);
