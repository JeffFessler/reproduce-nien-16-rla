  function [xs, info] = pwls_os_lalm(x, Ab, yi, R, varargin)
%|function [xs, info] = pwls_os_lalm(x, Ab, yi, R, [options])
%|
...
%|    chat
%|    ii0                     initial index of continuation (default 1)
%|
%| out
